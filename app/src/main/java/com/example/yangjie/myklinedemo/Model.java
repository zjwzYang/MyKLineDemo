...
//                public CandleEntry(int xIndex, float shadowH, float shadowL, float open, float close) {
    ...
    public static List<BarEntry> getBarEntries(List<StockListBean.StockBean> rawData, int startIndex) {
...
//                public CandleEntry(int xIndex, float shadowH, float shadowL, float open, float close) {
            ...
            BarEntry entry = new BarEntry(startIndex+i, stock.getHigh(), stock.getLow(), stock.getOpen(), stock.getClose(), Float.parseFloat(stock.getVolume()));
            entries.add(entry);
        }
        return entries;
    }
